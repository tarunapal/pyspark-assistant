...
exports.PySparkAnalyzer = void 0;
const vscode = require("vscode");
class PySparkAnalyzer {
    constructor() {
        this._analyzeChangesTimeout = undefined;
    ...
    detectCachingIssues(text, diagnostics, document) {
    ...
    estimatePerformanceImpact(operation, dataSize) {
        const impacts = {
            'cartesian-join': {
    ...
    getDataVolumeWarning(estimate, operation) {
        const warnings = {
            collect: {
    ...
    detectCartesianJoins(text, diagnostics, document) {
        ...
        while ((match = cartesianJoinPattern.exec(text)) !== null) {
            ...
            const diagnostic = new vscode.Diagnostic(range, `CRITICAL: Cartesian join detected!\n` +
                ...
                `Estimated Improvement: ${impact.improvementFactor}x faster with proper join conditions`, vscode.DiagnosticSeverity.Error);
    ...
    detectIneffcientOperations(text, diagnostics, document) {
    ...
    detectMemoryIssues(text, diagnostics, document) {
    ...
    detectDataSkew(text, diagnostics, document) {
...
exports.PySparkAnalyzer = PySparkAnalyzer;
//# sourceMappingURL=pysparkAnalyzer.js.map