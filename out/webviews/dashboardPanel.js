...
class DashboardPanel {
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('pysparkAssistantDashboard', 'PySpark Assistant Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
    ...
    updateSparkUIStatus(connected, url) {
